...
print(tabulate(table, headers=["Year", "Prod", "X=x-2014", "X^2", "xy"], tablefmt=""))
...
plt.ylabel('Production',color="orange")
plt.plot(x,l)
# print("Trend Equation : y=%d+%.2fx"%(a,b))
```
...
![Screenshot 2024-08-24 200307](https://github.com/user-attachments/assets/3b5549d8-0fc9-4111-8d8a-4a09ecba3b31)

B- POLYNOMIAL TREND ESTIMATION

![Screenshot 2024-08-24 200318](https://github.com/user-attachments/assets/580aaebd-c58c-4740-8a02-e1296a3a866e)
